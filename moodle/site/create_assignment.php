<?php
	...
	if($_POST['event_name']){
		...
		#$due_date[19]='/0';
		#echo $due_date;
		//$query = "Insert into `events` (`name`,`type`,`due_date`,`description`,`cid`,) values ('".$_POST['event_name']."','".$_POST['event_type']."','".$due_date."','".$_POST['descript']."','".$cid."')";
	...
	$tpl->assign("msg",$msg);
	$tpl->assign("event_type","assignment");
